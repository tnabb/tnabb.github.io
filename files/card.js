...
m_Card = [
	...
	, [224, 4, "Anolian", "If you learned [" + skillName(42, SRV) + "] Lvl 10, you will cast Lvl 10 instead.", 221, 56, 0]
	...
	, [236, 7, "Violy", "If you learned [" + skillName(201, SRV) + "] Lvl 5, you will cast Lvl 5 instead.", 221, 60, 0]
	...
	, [282, 4, "Aliza", "When receiving ATK based damage, 5% chance to cast [" + skillName(539, SRV) + "] on your attacker.<BR>If equipped by a [Dancer] class job: 10% chance instead.", 0]
	...
	, [451, 100, 0, "Movement Speed +5%<BR>Disables the auto-casting of [" + skillName(167, SRV) + "].<BR>Recover 1 SP when dealing ATK based damage.<BR><b>[Thief Class]</b><br>Removes the consumption of gemstones from skills that usually would.", 1, 5, 2, 5, 12, 5, 0]
	...
	, [457, 100, 0, "If the user knows [" + skillName(174, SRV) + "] Lvl 5, 5% chance to cast [" + skillName(174, SRV) + "] Lvl 5 when performing an ATK based attack.<BR><b>[Rogue Class]</b><br>All skill's SP cost -20%, Disables the auto-casting of [" + skillName(167, SRV) + "].", 1, 6, 2, 4, 5169, 10, 0]
	...
	, [551, 2, "Parus", "If equipped by a [Acolyte] class job: Your [Heal], [Sanctuary], and [" + skillName(245, SRV) + "] effectiveness +(refine/2)%", 99, 3, 0]
	...
	, [554, 5, "Randel (aRO)", "Enables the use of [" + skillName(157, SRV) + "] Lvl 1", 9, 10, 0]
	...
	, [558, 5, "Celia (aRO)", "Enables the use of [" + skillName(240, SRV) + "] Lvl 1", 9, 10, 0]
	, [559, 4, "Scholar Celia (aRO)", "<b>[Base DEX >= 110]</b> MATK +7%", 221, 166, 89, 7, 0]
	, [560, 5, "Chen (aRO)", "Enables the use of [" + skillName(185, SRV) + "] Lvl 2", 9, 10, 0]
